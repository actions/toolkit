...
This walkthrough assumes that you have gone through the basic [javascript action walkthrough](./typescript-action.md) and have a basic action set up. If not, we recommend you go through that first.
