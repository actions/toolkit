 ...
 * @param options the download options with the defaults set
 */
export declare function downloadCacheBlobStorage(key: string, archivePath: string, options: DownloadOptions, blobContainerName: string, connectionString: string): Promise<void>;
