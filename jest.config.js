module.exports = {
  ...
  transformIgnorePatterns: [
    '/node_modules/(?!(@octokit|@actions/github|@actions/http-client|@actions/io|@actions/exec|@actions/core|@actions/tool-cache|universal-user-agent|before-after-hook)/)'
  ],
  verbose: true
}
